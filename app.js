...
const translations = {
  'zh-CN': {
    ...
    support: {
      ...
      footerLink: '请我喝杯咖啡 ☕',
      entryHint: '💡 有新增需求或优化建议？欢迎提交',
      entryCta: '联系 / 打赏',
      requestBanner: '💡 有新增需求或优化建议？欢迎随时提出，帮助我做得更好！',
      modalTitle: '❤️ 感谢支持！',
      tabsAriaLabel: '打赏方式',
      cnTab: '国内',
      intlTab: '国际',
  ...
  en: {
    ...
    support: {
      ...
      entryHint: '💡 Feature request or improvement? Submit here',
      entryCta: 'Support / Contact',
      requestBanner: '💡 Feature request or improvement? Let me know and help make this better!',
